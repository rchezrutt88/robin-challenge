...
import * as data from '../../user_data-1.json'
...
test('it reads user data', () => {
  expect(transformedData).toEqual(arrayContaining(
    [
      {
        "user_id": 1,
        "time_zone": "UTC",
...
test('getMeetingTimes accepts an array of ids with with a start and end time', () => {
  const interval = Interval.fromISO("2019-01-01T00:00:00+0000/2019-01-01T23:59:59+0000");
